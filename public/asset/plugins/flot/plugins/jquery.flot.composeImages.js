...
function, which generates temporary imagesOrphan out of them. This function
...
failure in generating the temporary image. Temporary imagesOrphan are required
...
After all temporary imagesOrphan are generated, they are overlapped using
...
temporary imagesOrphan load their data.
*/
    ...
    function getGenerateTempImg(tempImg, canvasOrSvgSource) {
        ...
        return function doGenerateTempImg(successCallbackFunc, failureCallbackFunc) {
            ...
            tempImg.onabort = function(evt) {
                ...
                successCallbackFunc(tempImg); //call successCallback, to allow snapshot of all working imagesOrphan
            };
    ...
    function prepareImagesToBeComposed(sources, destination) {
        ...
        if (sources.length === 0) {
            ...
            if ((maxX - minX <= 0) || (maxY - minY <= 0)) {
                result = NEGATIVEIMAGESIZE; //this might occur on hidden imagesOrphan
            } else {
