                        ...
                        <div class="row text-right " style="direction: rtl" >
                            <div class="col-md-6" >
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3  @error('orphanNumber') is-invalid @enderror " required id="orphanNumber" name="orphanNumber" value="{{$orphan->orphanNumber}}">
                                    @error('orphanNumber')
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('orphanName') is-invalid @enderror " required id="orphanName" name="orphanName" value="{{$orphan->orphanName}}">
                                    @error('orphanName')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="number" class="form-control col-md-5 mr-md-3 @error('orphanIdentity') is-invalid @enderror " required id="orphanIdentity" name="orphanIdentity" value="{{$orphan->orphanIdentity}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="date" class="form-control col-md-5 mr-md-3 @error('dob') is-invalid @enderror" required id="dob" name="dob" value="{{$orphan->dob}}">
                                    @error('dob')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" class="form-control col-md-5 mr-md-3 @error('mothersIdentity') is-invalid @enderror" required id="mothersIdentity" name="mothersIdentity" value="{{$orphan->mothersIdentity}}" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('mothersName') is-invalid @enderror" required id="mothersName" name="mothersName" value="{{$orphan->mothersName}}" >
                                    @error('mothersName')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('breadwinnerName') is-invalid @enderror" required id="breadwinnerName" name="breadwinnerName" value="{{$orphan->breadwinnerName}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" class="form-control col-md-5 mr-md-3 @error('breadwinnerIdentity') is-invalid @enderror" required id="breadwinnerIdentity" name="breadwinnerIdentity" value="{{$orphan->breadwinnerIdentity}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('relativeRelation') is-invalid @enderror" required id="relativeRelation" name="relativeRelation" value="{{$orphan->relativeRelation}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('address') is-invalid @enderror" required id="address" name="address" value="{{$orphan->address}}" >
                                    @error('address')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="number" class="form-control col-md-5 mr-md-3 @error('phoneNumber') is-invalid @enderror" required id="phoneNumber" name="phoneNumber" value="{{$orphan->phoneNumber}}">
                                    @error('phoneNumber')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="number" class="form-control col-md-5 mr-md-3 @error('accountNumber') is-invalid @enderror" required id="accountNumber" name="accountNumber" value="{{$orphan->accountNumber}}">
                                    @error('accountNumber')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('educationalLevel') is-invalid @enderror" required id="educationalLevel" name="educationalLevel" value="{{$orphan->educationalLevel}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('guarantyType') is-invalid @enderror" required id="guarantyType" name="guarantyType" value="{{$orphan->guarantyType}}">
                                    @error('guarantyType')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('healthStatus') is-invalid @enderror" required id="healthStatus" name="healthStatus" value="{{$orphan->healthStatus}}">
                                    @error('healthStatus')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('disease') is-invalid @enderror" required id="disease" name="disease" value="{{$orphan->disease}}">
                                    @error('disease')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('educationalAttainmentLevel') is-invalid @enderror" required id="educationalAttainmentLevel" name="educationalAttainmentLevel" value="{{$orphan->educationalAttainmentLevel}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="date" class="form-control col-md-5 mr-md-3 @error('fathersDeathDate') is-invalid @enderror" required id="fathersDeathDate" name="fathersDeathDate" value="{{$orphan->fathersDeathDate}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-5 mr-md-3 @error('causeOfDeath') is-invalid @enderror" required id="causeOfDeath" name="causeOfDeath" value="{{$orphan->causeOfDeath}}">
                                    @error('causeOfDeath')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="date" class="form-control col-md-5 mr-md-3 @error('marketingDate') is-invalid @enderror"  id="marketingDate" name="marketingDate" value="{{$orphan->marketingDate}}">
                                    @error('marketingDate')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="date" class="form-control col-md-5 mr-md-3 @error('guarantyDate') is-invalid @enderror"  id="guarantyDate" name="guarantyDate" value="{{$orphan->guarantyDate}}">
                                    @error('guarantyDate')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
