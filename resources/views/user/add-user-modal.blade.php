<div class="modal fade addUser" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="direction: rtl; text-align: right">
                  <form action="{{ route('add.user') }}" method="post" id="add-user-form" autocomplete="off">
                                @csrf
